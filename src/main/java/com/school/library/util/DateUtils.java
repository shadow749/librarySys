...
//    public static Date CurrTime = new Date(now);
    ...
    public static String getCurrMouth() {
        Date date_time = new Date();
        return FormatDate(date_time, "yyyy-MM");
    }
    ...
    public static String getCurrTime2() {
    	Date date_time = new Date();
    	return FormatDate(date_time, DATESTYLE);
    }
...
//        }
    ...
    public static Date addDayWithTime2(Date date , int n) {
        try {
            Calendar cd = Calendar.getInstance();
            cd.setTime(date);
            cd.add(Calendar.DATE, n);// 增加一天
	...
	public static String addDayWithTime(Date date , int n) {
		try {
...
//			cd.add(Calendar.DATE, n);// 增加一天
    ...
    public static Date addMonth2(Date s, int n) {
        try {
            Calendar cd = Calendar.getInstance();
            cd.setTime(s);
            cd.add(Calendar.MONTH, n);//增加一个月
	 ...
	 * @return 减后的日期
	 */
	public static String delMonth(String s, int n) {
		try {
...
//			cd.add(Calendar.DATE, -n);// 增加一天
    ...
    public static Date addHour2(Date s,int n) {
        try {
            Calendar cd = Calendar.getInstance();
            cd.setTime(s);
//			cd.add(Calendar.DATE, -n);// 增加一天
	...
	public static String addMinute(String s,int n) {
		try {
			...
			cd.setTime(sdf.parse(s));
//			cd.add(Calendar.DATE, -n);// 增加一天
			cd.add(Calendar.MINUTE, n);//增加一个月
			return sdf.format(cd.getTime());
    ...
    public static Date addMinute2(Date s,int n) {
        try {
            Calendar cd = Calendar.getInstance();
            cd.setTime(s);
//			cd.add(Calendar.DATE, -n);// 增加一天
    ...
    public static boolean isSameMonth(Date d1,Date d2){
	    String s1=dateToString(d1,"yyyy-MM");
	    String s2=dateToString(d2,"yyyy-MM");
	    return  s1.equals(s2);
    }
}
